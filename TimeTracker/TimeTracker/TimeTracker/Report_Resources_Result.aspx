<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TimeTracker/MasterPage.master" CodeBehind="Report_Resources_Result.aspx.cs" Inherits="TimeTracker.TimeTracker.Report_Resources_Result_aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    <div id="projectreport">
        ...
        <fieldset>
            ...
            <asp:ObjectDataSource ID="UserReportData" runat="server" TypeName="TimeTracker.BLL.UserTotalDurationReport"
                        ...
                        <asp:DataList ID="UserList" runat="server" Width="100%" DataSourceID="UserReportData"
                            ...
                            <ItemTemplate>
                                ...
                                <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                    <tr>
                                        <td>
                                            <asp:ObjectDataSource ID="TimeEntryData" runat="server" TypeName="TimeTracker.BLL.TimeEntry"
