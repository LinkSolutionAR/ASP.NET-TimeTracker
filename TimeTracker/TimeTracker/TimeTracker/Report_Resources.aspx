<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TimeTracker/MasterPage.master" CodeBehind="Report_Resources.aspx.cs" Inherits="TimeTracker.TimeTracker.Report_Resources_aspx" %>
    ...
    <div id="projectreport">
        ...
        <fieldset>
            ...
            <p>
                ...
                <br />
                <asp:ObjectDataSource ID="UserData" runat="server" TypeName="TimeTracker.BLL.Project" />
